...
public class Binds {
   ...
   * 
   * @param teleopMode A consumer which provides an {@code EventLoop} to bind to. Best done in the {@code RobotContainer}.
   */
  public static void configureTeleopBinds(Consumer<EventLoop> teleopMode) { Binds.teleopMode = teleopMode; }

  /**
   * Configure common use-case test binds.
   * 
   * @param testMode A consumer which provides an {@code EventLoop} to bind to. Best done in the {@code RobotContainer}.
   */
  public static void configureTestBinds(Consumer<EventLoop> testMode) { Binds.testMode = testMode; }
   ...
   */
  public EventLoop eventLoop() { return loop; }
  ...
  public Binds addTeleopBinds() {
    if(teleopMode == null)
      throw new IllegalStateException("Error: No Teleop binds set up. Call Binding.configureTeleopBinds() before calling this method.");
  ...
  public Binds addTestBinds() {
    if(teleopMode == null)
      throw new IllegalStateException("Error: No Test binds set up. Call Binding.configureTestBinds() before calling this method.");
  ...
  /**
   * Generates & saves the bind you have made, so that it can be set as the active control scheme in the future.
   */
  public void save() {
