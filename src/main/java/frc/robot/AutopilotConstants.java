...
public class AutopilotConstants {
  public static final APConstraints K_CONSTRAINTS = new APConstraints(4.0, 10);
  ...
  public static final APConstraints K_CLIMBING_CONSTRAINTS = new APConstraints(4, 6.0);
  public static final APProfile kClimbingProfile =
      new APProfile(K_CLIMBING_CONSTRAINTS)
          .withErrorXY(Distance.ofRelativeUnits(4, Inch))
          .withErrorTheta(Angle.ofRelativeUnits(3, Degree))
